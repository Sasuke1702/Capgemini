...
First translate the value that the user entered into seconds. Then use four successive single-
branch if statements each of which tests for one of the four cases: 1 item, 2 items, 3 items, more
