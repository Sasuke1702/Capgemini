package com.example.onetooneAssignment;
...
public class OnetooneAssignmentApplication {

	public static void main(String[] args) throws Exception {
		ApplicationContext context = SpringApplication.run(OnetooneAssignmentApplication.class, args);
