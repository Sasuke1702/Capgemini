...
exception. In the catch block, print the class name of the exception thrown.
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < arr.length; i = i + 1) {
            ...
            try {
                ...
                int n2 = sc.nextInt();
                System.out.println("The array element at index" + n2 + "=" + arr[n2]);
